...
var EditUser = function (props) {
    ...
    return (React.createElement("div", { className: "ui placeholder segment" },
        React.createElement("div", { className: "ui two column very relaxed stackable grid landpage-image" },
            React.createElement("div", { className: "column" },
                React.createElement("form", { onSubmit: submit, className: "ui form" },
                    React.createElement("h3", { className: "header grey centered" }, " Edit User Info"),
                    React.createElement("div", { className: " six wide field" },
                        React.createElement("label", null, "Email"),
                        React.createElement("div", { className: "ui left icon input" },
                            React.createElement("input", { type: "email", name: "email", placeholder: props.email, onChange: function (e) { return setEmail(e.target.value); } }),
                            React.createElement("i", { className: "email icon" }))),
                    React.createElement("div", { className: " six wide field" },
                        React.createElement("label", null, "First Name"),
                        React.createElement("div", { className: "ui left icon input" },
                            React.createElement("input", { type: "text", name: "first name", placeholder: datafirstname, onChange: function (e) { return setFirstName(e.target.value); } }),
                            React.createElement("i", { className: "user icon" }))),
                    React.createElement("div", { className: " six wide field" },
                        React.createElement("label", null, "Last Name"),
                        React.createElement("div", { className: "ui left icon input" },
                            React.createElement("input", { type: "text", name: "last name", placeholder: datalastname, onChange: function (e) { return setLastName(e.target.value); } }),
                            React.createElement("i", { className: "user icon" }))),
                    React.createElement("div", { className: " six wide field" },
                        React.createElement("label", null, "Date of Birthday"),
                        React.createElement("div", { className: "ui left icon input" },
                            React.createElement("input", { type: "data", name: "date of birthday", placeholder: datadateOfBirth, onChange: function (e) { return setDateOfBirth(e.target.value); } }),
                            React.createElement("i", { className: "email icon" }))),
                    React.createElement("div", { className: " six wide field" },
                        React.createElement("label", null, "Nationality"),
                        React.createElement("div", { className: "ui left icon input" },
                            React.createElement("input", { type: "text", name: "nationality", placeholder: datanationality, onChange: function (e) { return setNationality(e.target.value); } }),
                            React.createElement("i", { className: "user icon" }))),
                    React.createElement("button", { className: "ui button", type: "submit", color: "tail" }, "Submit"))),
            React.createElement("div", { className: "middle aligned column" },
                React.createElement("div", { className: "ui big button" },
                    React.createElement("div", null, "Account Balance"),
